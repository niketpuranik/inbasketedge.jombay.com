 ...
 * Webpack Constants
 */
const ENV = process.env.NODE_ENV = process.env.ENV = 'staging_internal';
const HOST = process.env.HOST || 'inbasketedgeinternal.ur-nl.com';
  ...
  return webpackMerge(commonConfig({
    ...
    plugins: [
      ...
      new DefinePlugin({
        ...
        'PROCTOR_HOST': JSON.stringify("https://simulationinternal.ur-nl.com")
      }),
